...
# Ahora vemos el promedio del precio
...
# Y de esta manera podemos ver que las comuna 1, 2, 14 y 13 son las que vendieron a precios mas altos 
# Por este motivo queremos estudiar cual es la relacion que hay con la cercania al subte y los valores de la propiedad
# Dado que la Comuna 14 fue la que mas propiedades vendidas tuvo, con un mercado muy amplio (como vimos en el analisis fue la que mas monoambientes y propiedades con mas de 6 ambientes tuvo a la vente)
# Tambien es de las comunas con precios mas elevados, es que ahoremos foco en ella para estudiar el efecto del subte. 
...
ggplot()+
  geom_sf(data=filter(barrios), colour="grey", alpha=0.2)+
